...
for hand_bid in hand_bids:
    hand_bid[0] = hand_bid[0].replace("K", "B").replace("Q", "C").replace("J", "D").replace("T", "E").replace("9", "F").replace("8", "G").replace("7", "H").replace("6", "I").replace("5", "J").replace("5", "K").replace("4", "L").replace("3", "M").replace("2", "N")
    hand = hand_bid[0]
